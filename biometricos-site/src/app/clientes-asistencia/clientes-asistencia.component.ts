...
@Component({
  selector: 'app-clientes-asistencia',
  templateUrl: './clientes-asistencia.component.html',
  styleUrls: ['./clientes-asistencia.component.css']
})
export class ClientesAsistenciaComponent implements OnInit {
