...
export class DirectivaService {
  ...
  private urlGetInfoMes: string = 'http://localhost:8081/contro-asistencia-devant/user-devant/info-mes';
  ...
  getInfoMonth(): Observable<InfoMes> {
    return this.http.get<InfoMes>(this.urlGetInfoMes)
      .pipe(map(res => res));
  }
